    ...
    content:
      ...
      text: |
        <div style="display: flex; justify-content: center; margin-top: 2em; overflow-x: hidden; width: 100%;">
          ...
          <div class="mainpage-cols" style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px); padding: 28px 24px; border-radius: 10px; color: #fff; text-align:left; font-size:0.8em; max-width: 2400px !important; width: 100%; margin: 0 auto; box-sizing: border-box; display: flex; flex-direction: row; flex-wrap: wrap; justify-content: space-between; gap: 12px;">
